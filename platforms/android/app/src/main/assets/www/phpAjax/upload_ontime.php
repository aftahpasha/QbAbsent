...
$query = "INSERT INTO test VALUES ('$_GET[email]','$_GET[name]','$_GET[tanggal]','$_GET[bulan]','$_GET[tahun]','$_GET[jam_datang]','$_GET[menit_datang]','$_GET[jam_pulang]','$_GET[menit_pulang]','TEPAT WAKTU')";
